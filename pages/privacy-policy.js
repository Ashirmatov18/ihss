      ...
      <main>
        ...
        <div style={{ padding: "0 20px" }}>
          ...
          <h4>
            ...
            составлена в соответствии с требованиями Закона об информации
            персонального характера г. Бишкек от 14 апреля 2008 года №58 в
            редакции Закона КР от 20 июля 2017 года №129, 29 ноября 2021 года
            №142 и определяет порядок обработки персональных данных и меры по
            обеспечению безопасности персональных данных, предпринимаемые НЖК
            "Ихсан Групп ЛТД" (далее – Оператор).
          </h4>
          ...
          может получить о посетителях веб-сайта https://ihsan.kg/, и для
          мобильного приложения IHSAN которая используется Оператором.
          ...
          адресу https://ihsan.kg/. 2.4. Информационная система персональных
          ...
          использования пайщиками в онлайн режиме. 2.8.1 Пользователь мобильного
          приложения IHSAN – внутренний пользователь для получения информации по
          жилищным программам, по формированию очередности и для получения
          информации в виде уведомления от Оператора. 2.9. Распространение
          ...
          наличии оснований, указанных в Закона об информации персонального
          характера; – самостоятельно определять состав и перечень мер,
          необходимых и достаточных для обеспечения выполнения обязанностей,
          предусмотренных Закона об информации персонального характера и
          принятыми в соответствии с ним нормативными правовыми актами, если
          иное не предусмотрено - информировать в виде уведомления через
          мобильное приложение IHSAN - формировать данные пайщиков по
          очерёдности и через мобильное приложение IHSAN доводить информацию в
          онлайн режиме. 3.2. Оператор обязан: – предоставлять субъекту
          ...
          Кыргызской Республики; – отвечать на обращения и запросы субъектов
          персональных данных и их законных представителей в соответствии с
          требованиями Закона об информации персонального характера; –
          ...
          действий в отношении персональных данных; – исполнять иные
          обязанности, предусмотренные Закона об информации персонального
          характера.
          ...
          предусмотренных другими законами. Сведения предоставляются субъекту
          ...
          и порядок ее получения установлен Закона об информации персонального
          характера; – требовать от оператора уточнения его персональных данных,
          ...
          5.7.1 Передача (распространение, предоставление, доступ) персональных
          ...
          направлено. 5.7.2 Согласие на обработку персональных данных,
          разрешенных для распространения, прекращает свое действие с момента
          поступления Оператору требования, указанного в п. 5.7.1 настоящей
          ...
          материалам, содержащимся на веб-сайте https://ihsan.kg/; -
          предоставлением доступа через авторизацию в мобильное приложение
          IHSAN; - добровольности членства в кооперативе и беспрепятственного
          выхода из него в порядке, установленном уставом кооператива в онлайн
          режиме; - взаимопомощи и обеспечения экономической выгоды для членов
          кооператива, участвующих в его хозяйственной деятельности; -
          управления деятельностью кооператива на демократических началах через
          онлайн голосование в мобильном приложении; - предназначения
          кооператива для наиболее полного удовлетворения экономических
          потребностей его участников; - сохранения экономической и
          хозяйственной самостоятельности членов кооператива; - создания условий
          для повышения образовательного уровня членов кооператива; -
          доступности информации о деятельности кооператива и его финансовом
          состоянии для его членов в порядке, установленном уставом кооператива.
          ...
          электронной почты ihsangroupltd@gmail.com с пометкой «Отказ от
          ...
          специальные формы, расположенные на сайте https://ihsan.kg/ или
          ...
          персональных данных на обработку его персональных данных. 9.5.
          ...
          электронной почты Оператора ihsangroupltd@gmail.com с пометкой
          ...
          адрес Оператора ihsangroupltd@gmail.com с пометкой «Отзыв согласия на
          ...
          законодательством Кыргызской Республики. 10.7. Оператор при обработке
          ...
          хранения персональных данных не установлен иными законами, договором,
          ...
          субъекта персональных данных или отзыв согласия субъектом персональных
          ...
          Оператору с помощью электронной почты ihsangroupltd@gmail.com. 13.2. В
          ...
          ее новой версией. 13.3. Актуальная версия Политики в свободном доступе
          расположена в сети Интернет по адресу https://ihsan.kg/privacy/.
        </div>
        <Footer />
      </main>
    </>
